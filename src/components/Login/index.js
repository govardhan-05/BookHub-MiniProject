    ...
    return (
      <div className="login-responsive-container">
        <div className="login-page-left-side-section">
          <img
            src="https://res.cloudinary.com/govardhan05/image/upload/v1667717309/Rectangle_1467_fp3eo9.png"
        ...
        <div className="login-page-right-side-section">
          <div className="login-card">
            <img
              src="https://res.cloudinary.com/govardhan05/image/upload/v1667717661/Group_7731_egp8xo.png"
