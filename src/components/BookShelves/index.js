      ...
      {value => {
        ...
        return (
          <div className="no-books-container">
            <img
              src="https://res.cloudinary.com/govardhan05/image/upload/v1667793355/Asset_1_1_zobops.png"
              className="no-books"
              alt="no books"
            />
                        ...
                        <Link to={`/books/${id}`} className="text-links">
                          <li key={id} className="bookslist-item">
                            ...
                            <div className="books-details-container">
                              <h1
                                key={title}
                                className={`book-shelf-title ${textColor}`}
                              >
                                {title}
                              </h1>
                              <p
      ...
      {value => {
        ...
        return (
          <div className={`${bgColor} book-shelves-failure-view-container`}>
            <img
              src="https://res.cloudinary.com/govardhan05/image/upload/v1667800896/Group_7522_tmjv4p.png"
